...
class Cust_DialogAdapter(private val context: Activity, private val datas: List<Customer>) : BaseArrayRecyclerAdapter<Customer>(datas) {
    ...
    override fun onBindHoder(holder: BaseRecyclerAdapter.RecyclerHolder, entity: Customer, pos: Int) {
        // 初始化id
    ...
    interface MyCallBack {
        fun onClick(entity: Customer, position: Int)
    }
