 ...
 * 作者：ykk
 */
class OtherInStock2_MainActivity : BaseActivity() {
    ...
    private val TAG = "OtherInStock2_MainActivity"
    ...
    val fragment1 = OtherInStock2_Fragment1()
    val fragment2 = OtherInStock2_Fragment2()
    val fragment3 = OtherInStock2_Fragment3()
    var isMainSave = false // 主表信息是否保存
    var pageId = 0

    override fun setLayoutResID(): Int {
        return R.layout.ware_other_in_stock2_main;
    }
