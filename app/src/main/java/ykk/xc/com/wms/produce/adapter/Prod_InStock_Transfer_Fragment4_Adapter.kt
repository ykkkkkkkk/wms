...
class Prod_InStock_Transfer_Fragment4_Adapter(private val context: Activity, datas: List<ICStockBillEntry_Barcode>) : BaseArrayRecyclerAdapter<ICStockBillEntry_Barcode>(datas) {
    private val df = DecimalFormat("#.######")
    private var callBack: MyCallBack? = null

    override fun bindView(viewtype: Int): Int {
        return R.layout.prod_instock_transfer_fragment4_item
    }
