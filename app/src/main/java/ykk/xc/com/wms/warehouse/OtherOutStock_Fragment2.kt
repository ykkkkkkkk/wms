...
import kotlinx.android.synthetic.main.ware_sc_other_out_stock_fragment2.*
import okhttp3.*
...
class OtherOutStock_Fragment2 : BaseFragment() {
    ...
    override fun setLayoutResID(inflater: LayoutInflater, container: ViewGroup): View {
        return inflater.inflate(R.layout.ware_sc_other_out_stock_fragment2, container, false)
    }
...
//        }
        ...
        if (parseDouble(getValues(tv_stockQty)) <= 0) {
            Comm.showWarnDialog(mContext, "该物料没有库存！")
            return false;
        }
        return true;
    }
