...
import kotlinx.android.synthetic.main.pur_receive_qc_fragment3.*
import kotlinx.android.synthetic.main.pur_receive_qc_main.viewPager
import okhttp3.*
...
import ykk.xc.com.wms.purchase.adapter.Pur_Receive_QC_Fragment3_Adapter
 ...
 * 作者：ykk
 */
class Pur_Receive_QC_Fragment3 : BaseFragment() {
    ...
    private var mAdapter: Pur_Receive_QC_Fragment3_Adapter? = null
    ...
    private class MyHandler(activity: Pur_Receive_QC_Fragment3) : Handler() {
        private val mActivity: WeakReference<Pur_Receive_QC_Fragment3>
    ...
    override fun setLayoutResID(inflater: LayoutInflater, container: ViewGroup): View {
        return inflater.inflate(R.layout.pur_receive_qc_fragment3, container, false)
    }
    ...
    override fun initView() {
        ...
        mAdapter = Pur_Receive_QC_Fragment3_Adapter(mContext!!, checkDatas)
        recyclerView.adapter = mAdapter
        // 设值listview空间失去焦点
        recyclerView.isFocusable = false

        // 行事件
        mAdapter!!.setCallBack(object : Pur_Receive_QC_Fragment3_Adapter.MyCallBack {
