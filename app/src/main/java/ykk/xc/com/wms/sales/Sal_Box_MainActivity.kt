...
import kotlinx.android.synthetic.main.sal_box_main.*
 ...
 * 销售装箱
 */
class Sal_Box_MainActivity : BaseActivity() {
    ...
    private val TAG = "Sal_Box_MainActivity"
    ...
    val fragment1 = Sal_Box_Fragment1()
    var pageId = 0
