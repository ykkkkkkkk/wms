...
import kotlinx.android.synthetic.main.sal_qcpass_fragment3.*
...
import ykk.xc.com.wms.sales.adapter.Sal_QcPass_Fragment3_Adapter
...
class Sal_QcPass_Fragment3 : BaseFragment() {
    ...
    private var mAdapter: Sal_QcPass_Fragment3_Adapter? = null
    ...
    private class MyHandler(activity: Sal_QcPass_Fragment3) : Handler() {
        private val mActivity: WeakReference<Sal_QcPass_Fragment3>
...
//                        m.parent!!.fragment1.reset() // 重置
    ...
    override fun setLayoutResID(inflater: LayoutInflater, container: ViewGroup): View {
        return inflater.inflate(R.layout.sal_qcpass_fragment3, container, false)
    }
    ...
    override fun initView() {
        ...
        mAdapter = Sal_QcPass_Fragment3_Adapter(mContext!!, checkDatas)
        recyclerView.adapter = mAdapter
        // 设值listview空间失去焦点
        recyclerView.isFocusable = false

        // 行事件
        mAdapter!!.setCallBack(object : Sal_QcPass_Fragment3_Adapter.MyCallBack {
