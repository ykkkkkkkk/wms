 ...
 * 作者：ykk
 */
class Sal_FinanceSignatureActivity : BaseActivity() {
    ...
    private class MyHandler(activity: Sal_FinanceSignatureActivity) : Handler() {
        private val mActivity: WeakReference<Sal_FinanceSignatureActivity>
