...
import ykk.xc.com.wms.produce.adapter.Prod_Picking_Fragment3_Adapter
...
class Prod_Transfer_Fragment3 : BaseFragment() {
    ...
    private var mAdapter: Prod_Picking_Fragment3_Adapter? = null
    ...
    override fun initView() {
        ...
        mAdapter = Prod_Picking_Fragment3_Adapter(mContext!!, checkDatas)
        recyclerView.adapter = mAdapter
        // 设值listview空间失去焦点
        recyclerView.isFocusable = false

        // 行事件
        mAdapter!!.setCallBack(object : Prod_Picking_Fragment3_Adapter.MyCallBack {
