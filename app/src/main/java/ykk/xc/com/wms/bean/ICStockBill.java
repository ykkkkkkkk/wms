...
public class ICStockBill implements Serializable {
	...
	/* 单据类型( QTRK:其他入库，QTCK:其他出库，CGRK:采购入库，CGSHRK:采购收货入库，CGSHCZ:采购收货操作，CGSHCZ_DBD:采购收货操作_调拨单，CGSHCZ_BTOR:采购收货操作_红字外购入库，CGSHCZ_QTRK:采购收货操作_其他入库
			  XSCK:销售出库，SCRK:生产入库， SCLL:生产领料，DBD:调拨单，WWCK:委外出库，WWRK:委外入库，STRK：受托入库,STLL:受托领料	) */
