...
import kotlinx.android.synthetic.main.sal_out_stock_fragment1.tv_suppSel
...
import ykk.xc.com.wms.bean.k3Bean.*
 ...
 * 作者：ykk
 */
class Sal_OutStockFragment2 : BaseFragment() {
    ...
    companion object {
        ...
        private val RESULT_SALORDER_ORDER = 8
    }
    ...
    private var parent: Sal_OutStockMainActivity? = null
    ...
    private class MyHandler(activity: Sal_OutStockFragment2) : Handler() {
        private val mActivity: WeakReference<Sal_OutStockFragment2>
    ...
    override fun setLayoutResID(inflater: LayoutInflater, container: ViewGroup): View {
        return inflater.inflate(R.layout.sal_out_stock_fragment2, container, false)
    }

    override fun initView() {
        mContext = getActivity()
        parent = mContext as Sal_OutStockMainActivity
    ...
    fun onViewClicked(view: View) {
        when (view.id) {
            ...
            R.id.btn_sourceNoSel -> { // 选择来源单据
                ...
                val bundle = Bundle()
                bundle.putInt("fcustId", parent!!.fragment1.icStockBill.fsupplyId)
                bundle.putString("custName", parent!!.fragment1.icStockBill.suppName)
                bundle.putString("strFdetailId", strFdetailId.toString())
                when(icStockBillEntry.fsourceTranType) {
                    81 -> showForResult(Sal_OutStock_SelSeOrderActivity::class.java, RESULT_SALORDER_ORDER, bundle)
                    83 -> showForResult(Sal_OutStock_SelSeOutStockActivity::class.java, RESULT_SALORDER_ORDER, bundle)
                }
            }
...
//                    icStockBillEntry.fdcSPId = stockPos!!.fspId
    ...
    private fun setICStockEntry_SeOrder(list : List<SeOrderEntry>) {
        parent!!.fragment1.icStockBill.fselTranType = 81
        ...
        val click = View.OnClickListener { v ->
            when (v.id) {
                ...
                R.id.btn2 -> {// 销售订单
                    ...
                    parent!!.fragment1.icStockBill.fselTranType = 81
                    icStockBillEntry.fsourceTranType = 81
                ...
                R.id.btn3 -> {// 发货通知单
                    ...
                    parent!!.fragment1.icStockBill.fselTranType = 83
                    icStockBillEntry.fsourceTranType = 83
                    btn_sourceNoSel.visibility = View.VISIBLE
                    lin_getMtl.visibility = View.INVISIBLE
                }
            }
