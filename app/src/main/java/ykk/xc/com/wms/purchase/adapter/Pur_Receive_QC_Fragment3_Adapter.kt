...
class Pur_Receive_QC_Fragment3_Adapter(private val context: Activity, datas: List<ICStockBillEntry>) : BaseArrayRecyclerAdapter<ICStockBillEntry>(datas) {
    private val df = DecimalFormat("#.######")
    private var callBack: MyCallBack? = null

    override fun bindView(viewtype: Int): Int {
        return R.layout.pur_receive_qc_fragment3_item
    }
    ...
    override fun onBindHoder(holder: BaseRecyclerAdapter.RecyclerHolder, entity: ICStockBillEntry, pos: Int) {
        ...
        val tv_qcPassQty = holder.obtainView<TextView>(R.id.tv_qcPassQty)
        ...
        tv_num.text = Html.fromHtml("入库数:&nbsp;<font color='#6a5acd'>"+ df.format(entity.fqty) +"</font>&nbsp;<font color='#666666'>"+ entity.unitName +"</font>")
        tv_qcPassQty.text = Html.fromHtml("合格数:&nbsp;<font color='#FF0000'>"+ df.format(entity.qcPassQty) +"</font>")
