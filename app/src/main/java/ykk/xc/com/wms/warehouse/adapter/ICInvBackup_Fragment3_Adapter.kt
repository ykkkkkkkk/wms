...
class ICInvBackup_Fragment3_Adapter(private val context: Activity, datas: List<ICItem>) : BaseArrayRecyclerAdapter<ICItem>(datas) {
    private val df = DecimalFormat("#.######")
    private var callBack: MyCallBack? = null

    override fun bindView(viewtype: Int): Int {
        return R.layout.ware_icinvbackup_fragment3_item
    }
