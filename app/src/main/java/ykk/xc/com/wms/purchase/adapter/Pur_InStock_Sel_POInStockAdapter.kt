...
class Pur_InStock_Sel_POInStockAdapter(private val context: Activity, private val datas: List<POInStockEntry>) : BaseArrayRecyclerAdapter<POInStockEntry>(datas) {
    ...
    override fun onBindHoder(holder: BaseRecyclerAdapter.RecyclerHolder, entity: POInStockEntry, pos: Int) {
        // 初始化id
    ...
    interface MyCallBack {
        fun onClick(entity: POInStockEntry, position: Int)
    }
