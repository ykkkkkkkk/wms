...
class Sal_OutStock_SelSeOrderAdapter(private val context: Activity, private val datas: List<SeOrderEntry>) : BaseArrayRecyclerAdapter<SeOrderEntry>(datas) {
    private val df = DecimalFormat("#.####")
    private var callBack: MyCallBack? = null

    override fun bindView(viewtype: Int): Int {
        return R.layout.sal_sel_seorder_item
    }

    override fun onBindHoder(holder: BaseRecyclerAdapter.RecyclerHolder, entity: SeOrderEntry, pos: Int) {
        // 初始化id
    ...
    interface MyCallBack {
        fun onClick(entity: SeOrderEntry, position: Int)
    }
