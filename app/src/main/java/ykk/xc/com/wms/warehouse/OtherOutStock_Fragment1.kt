...
import kotlinx.android.synthetic.main.ware_sc_other_out_stock_fragment1.*
...
//    var isReset = false // 是否点击了重置按钮
    ...
    override fun setLayoutResID(inflater: LayoutInflater, container: ViewGroup): View {
        return inflater.inflate(R.layout.ware_sc_other_out_stock_fragment1, container, false)
    }
    ...
    @OnClick(R.id.tv_inDateSel, R.id.tv_suppSel, R.id.tv_deptSel, R.id.tv_emp1Sel, R.id.tv_emp2Sel, R.id.tv_emp3Sel, R.id.tv_emp4Sel, R.id.btn_save, R.id.btn_clone)
    ...
    fun checkSave() : Boolean {
        if (icStockBill.fsupplyId == 0 && icStockBill.fdeptId == 0) {
            Comm.showWarnDialog(mContext, "客户或部门必须选一个！")
            return false;
        }
