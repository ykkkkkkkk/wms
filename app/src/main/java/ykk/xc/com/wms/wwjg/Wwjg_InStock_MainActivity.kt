 ...
 * 作者：ykk
 */
class Wwjg_InStock_MainActivity : BaseActivity() {

    private val REFRESH = 1

    private val context = this
    private val TAG = "Wwjg_InStock_MainActivity"
    ...
    val fragment1 = Wwjg_InStock_Fragment1()
    val fragment2 = Wwjg_InStock_Fragment2()
    val fragment3 = Wwjg_InStock_Fragment3()
    var isMainSave = false // 主表信息是否保存

    override fun setLayoutResID(): Int {
        return R.layout.wwjg_in_stock_main;
    }
    ...
    fun onViewClicked(view: View) {
        ...
        when (view.id) {
            ...
            R.id.btn_search -> { // 查询
                ...
                bundle.putString("billType", "WWJGRK")
