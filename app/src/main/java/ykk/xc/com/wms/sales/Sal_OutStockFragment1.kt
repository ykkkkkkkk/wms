 ...
 * 作者：ykk
 */
class Sal_OutStockFragment1 : BaseFragment() {
...
//    var isReset = false // 是否点击了重置按钮
    ...
    private class MyHandler(activity: Sal_OutStockFragment1) : Handler() {
        private val mActivity: WeakReference<Sal_OutStockFragment1>
    ...
    @OnClick(R.id.tv_inDateSel, R.id.tv_suppSel, R.id.tv_deptSel, R.id.tv_stockSel, R.id.tv_emp1Sel, R.id.tv_emp2Sel, R.id.tv_emp3Sel, R.id.tv_emp4Sel,
