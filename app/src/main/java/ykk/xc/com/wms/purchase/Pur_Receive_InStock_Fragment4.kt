...
import ykk.xc.com.wms.purchase.adapter.Pur_Receive_InStock_Fragment4_Adapter
    ...
    fun onEventBus(entity: EventBusEntity) {
        when (entity.caseId) {
            32 -> { // 接收第三个页面（32）发来的指令
                ...
                tv_sourceQty.text = Html.fromHtml("源单数:&nbsp;<font color='#6a5acd'>"+ df.format(icstockBillEntry!!.fsourceQty) +"</font>&nbsp;<font color='#666666'>"+ icstockBillEntry!!.unitName +"</font>")
