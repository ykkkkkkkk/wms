 ...
 * 作者：ykk
 */
class Pur_Receive_QC_MainActivity : BaseActivity() {
    ...
    val fragment1 = Pur_Receive_QC_Fragment1()
    val fragment2 = Pur_Receive_QC_Fragment2()
    val fragment3 = Pur_Receive_QC_Fragment3()
    val fragment4 = Pur_Receive_QC_Fragment4()
    var isMainSave = false // 主表信息是否保存
    var pageId = 0

    override fun setLayoutResID(): Int {
        return R.layout.pur_receive_qc_main;
    }
