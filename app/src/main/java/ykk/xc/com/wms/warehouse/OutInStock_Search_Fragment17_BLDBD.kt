 ...
 * 作者：ykk
 */
class OutInStock_Search_Fragment17_BLDBD : BaseFragment() {
    ...
    private var mAdapter: OutInStockSearchFragment17_BLDBD_Adapter? = null
    ...
    private class MyHandler(activity: OutInStock_Search_Fragment17_BLDBD) : Handler() {
        private val mActivity: WeakReference<OutInStock_Search_Fragment17_BLDBD>
    ...
    override fun initView() {
        ...
        mAdapter = OutInStockSearchFragment17_BLDBD_Adapter(mContext!!, checkDatas)
        recyclerView.adapter = mAdapter
        // 设值listview空间失去焦点
        recyclerView.isFocusable = false

        // 行事件
        mAdapter!!.setCallBack(object : OutInStockSearchFragment17_BLDBD_Adapter.MyCallBack {
            override fun onSearch(entity: ICStockBill, position: Int) {
                val bundle = Bundle()
                bundle.putInt("id", entity.id)
                show(Ware_ICItemScrap_Transfer_MainActivity::class.java, bundle)
            }
