...
import kotlinx.android.synthetic.main.sal_outstock_red_fragment2.*
import okhttp3.*
 ...
 * 作者：ykk
 */
class Sal_OutStock_RED_Fragment2 : BaseFragment() {
    ...
    private class MyHandler(activity: Sal_OutStock_RED_Fragment2) : Handler() {
        private val mActivity: WeakReference<Sal_OutStock_RED_Fragment2>
...
//                                    Comm.showWarnDialog(m.mContext,"请先保存当前数据！")
                    ...
                    SAVE -> { // 保存成功 进入
                        m.parent!!.fragment1.seoutStockEntryList = null
                        // 保存了分录，供应商就不能修改
...
//                                }
    ...
    override fun setLayoutResID(inflater: LayoutInflater, container: ViewGroup): View {
        return inflater.inflate(R.layout.sal_outstock_red_fragment2, container, false)
    }
...
//        getStockGroup(null)
    ...
    override fun setUserVisibleHint(isVisibleToUser: Boolean) {
        ...
        if (isVisibleToUser) {
            if(parent!!.fragment1.seoutStockEntryList != null) {
                // 执行保存功能
                setICStockEntry_SeoutStock(parent!!.fragment1.seoutStockEntryList)
            }
...
//            entry.fqty = it.useableQty
            ...
            entry.fsourceTranType = 82
            entry.fsourceBillNo = it.seOutStock.fbillno
