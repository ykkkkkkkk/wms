...
import ykk.xc.com.wms.warehouse.adapter.OutInStockSearchFragment17_BLDBD_Adapter
import ykk.xc.com.wms.warehouse.adapter.OutInStockSearchFragment18_QTDBD_Adapter
 ...
 * 作者：ykk
 */
class OutInStock_Search_Fragment18_QTDBD : BaseFragment() {
    ...
    private var mAdapter: OutInStockSearchFragment18_QTDBD_Adapter? = null
    ...
    private class MyHandler(activity: OutInStock_Search_Fragment18_QTDBD) : Handler() {
        private val mActivity: WeakReference<OutInStock_Search_Fragment18_QTDBD>
    ...
    override fun initView() {
        ...
        mAdapter = OutInStockSearchFragment18_QTDBD_Adapter(mContext!!, checkDatas)
        recyclerView.adapter = mAdapter
        // 设值listview空间失去焦点
        recyclerView.isFocusable = false

        // 行事件
        mAdapter!!.setCallBack(object : OutInStockSearchFragment18_QTDBD_Adapter.MyCallBack {
            override fun onSearch(entity: ICStockBill, position: Int) {
                val bundle = Bundle()
                bundle.putInt("id", entity.id)
                show(Ware_Other_Transfer_MainActivity::class.java, bundle)
            }
