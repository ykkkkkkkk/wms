...
import kotlinx.android.synthetic.main.ware_plant_mould_main.*
 ...
 * 作者：ykk
 */
class PlantMould_MainActivity : BaseActivity() {
    ...
    val fragment1 = PlantMould_Fragment1()
    val fragment2 = PlantMould_Fragment2()
    var isMainSave = false // 主表信息是否保存
    private val REFRESH = 1

    override fun setLayoutResID(): Int {
        return R.layout.ware_plant_mould_main;
    }
