...
import kotlinx.android.synthetic.main.ware_other_in_stock2_fragment3.*
...
import ykk.xc.com.wms.warehouse.adapter.OtherInStock2Fragment3Adapter
 ...
 * 作者：ykk
 */
class OtherInStock2_Fragment3 : BaseFragment() {
    ...
    private var mAdapter: OtherInStock2Fragment3Adapter? = null
    ...
    private class MyHandler(activity: OtherInStock2_Fragment3) : Handler() {
        private val mActivity: WeakReference<OtherInStock2_Fragment3>
...
//                        m.parent!!.fragment1.reset() // 重置
    ...
    override fun setLayoutResID(inflater: LayoutInflater, container: ViewGroup): View {
        return inflater.inflate(R.layout.ware_other_in_stock2_fragment3, container, false)
    }
    ...
    override fun initView() {
        ...
        mAdapter = OtherInStock2Fragment3Adapter(mContext!!, checkDatas)
        recyclerView.adapter = mAdapter
        // 设值listview空间失去焦点
        recyclerView.isFocusable = false

        // 行事件
        mAdapter!!.setCallBack(object : OtherInStock2Fragment3Adapter.MyCallBack {
