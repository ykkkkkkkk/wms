...
import ykk.xc.com.wms.warehouse.adapter.OutInStockSearchFragment9_ProdInStockTransfer_Adapter
    ...
    override fun initView() {
        ...
        mAdapter!!.setCallBack(object : OutInStockSearchFragment9_ProdInStockTransfer_Adapter.MyCallBack {
            override fun onSearch(entity: ICStockBill, position: Int) {
                ...
                show(Prod_InStock_Transfer_MainActivity::class.java, bundle)
            }
