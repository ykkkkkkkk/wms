...
import kotlinx.android.synthetic.main.sal_out_stock_fragment3.*
...
import ykk.xc.com.wms.sales.adapter.Sal_OutStockFragment3Adapter
 ...
 * 作者：ykk
 */
class Sal_OutStockFragment3 : BaseFragment() {
    ...
    private var mAdapter: Sal_OutStockFragment3Adapter? = null
    ...
    private class MyHandler(activity: Sal_OutStockFragment3) : Handler() {
        private val mActivity: WeakReference<Sal_OutStockFragment3>
    ...
    override fun setLayoutResID(inflater: LayoutInflater, container: ViewGroup): View {
        return inflater.inflate(R.layout.sal_out_stock_fragment3, container, false)
    }
    ...
    override fun initView() {
        ...
        mAdapter = Sal_OutStockFragment3Adapter(mContext!!, checkDatas)
        recyclerView.adapter = mAdapter
        // 设值listview空间失去焦点
        recyclerView.isFocusable = false

        // 行事件
        mAdapter!!.setCallBack(object : Sal_OutStockFragment3Adapter.MyCallBack {
