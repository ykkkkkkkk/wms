...
import kotlinx.android.synthetic.main.ware_icitemscrap_transfer_fragment3.*
...
import ykk.xc.com.wms.warehouse.adapter.Ware_ICItemScrap_Transfer_Fragment3_Adapter
 ...
 * 作者：ykk
 */
class Ware_ICItemScrap_Transfer_Fragment3 : BaseFragment() {
    ...
    private var mAdapter: Ware_ICItemScrap_Transfer_Fragment3_Adapter? = null
    ...
    private class MyHandler(activity: Ware_ICItemScrap_Transfer_Fragment3) : Handler() {
        private val mActivity: WeakReference<Ware_ICItemScrap_Transfer_Fragment3>
...
//                            m.parent!!.fragment1.reset() // 重置
    ...
    override fun setLayoutResID(inflater: LayoutInflater, container: ViewGroup): View {
        return inflater.inflate(R.layout.ware_icitemscrap_transfer_fragment3, container, false)
    }
    ...
    override fun initView() {
        ...
        mAdapter = Ware_ICItemScrap_Transfer_Fragment3_Adapter(mContext!!, checkDatas)
        recyclerView.adapter = mAdapter
        // 设值listview空间失去焦点
        recyclerView.isFocusable = false

        // 行事件
        mAdapter!!.setCallBack(object : Ware_ICItemScrap_Transfer_Fragment3_Adapter.MyCallBack {
